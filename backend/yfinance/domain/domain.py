...
class Domain(ABC):
    ...
    def __init__(self, key: str, session=None):
        ...
        self._top_companies: _pd.DataFrame | None = None
        self._research_reports: list[dict[str, str]] | None = None
    ...
    def _parse_top_companies(self, top_companies) -> _pd.DataFrame | None:
        """
