...
class QueryBase(ABC):
    ...
    def _validate_eq_operand(self, operand: list[str | numbers.Real]) -> None:
        if len(operand) != 2:
    ...
    def _validate_btwn_operand(self, operand: list[str | numbers.Real]) -> None:
        if len(operand) != 3:
    ...
    def _validate_gt_lt(self, operand: list[str | numbers.Real]) -> None:
        if len(operand) != 2:
